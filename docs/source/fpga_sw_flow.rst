...
For every core listed in :doc:`support_matrix` as
...
:doc:`FPGA OpenOCD/GDB debugging <fpga_debug_stepping>`.
...
See :doc:`Core and board descriptors <core_board_descriptors>` for the
