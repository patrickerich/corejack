...
-  IP developers who want a ready-made vehicle to prototype and
   ...
   :ref:`system-ip-and-accelerator-expansion`.
...
+------------------+------------------+------------------+------------------+------------------+
| Project          | Primary language | Core focus       | Fabric /         | When to pick it  |
|                  |                  |                  | integration      | over CoreJack    |
|                  |                  |                  | style            |                  |
+==================+==================+==================+==================+==================+
| **Chipyard**     | Scala / Chisel   | BOOM, Rocket,    | T                | Generator-driven |
|                  |                  | plus generators  | ileLink-centric; | RTL with         |
|                  |                  |                  | massive          | parameterised    |
|                  |                  |                  | generator/test   | cache            |
|                  |                  |                  | infrastructure   | hierarchies,     |
|                  |                  |                  |                  | Be               |
|                  |                  |                  |                  | rkeley-ecosystem |
|                  |                  |                  |                  | flows            |
+------------------+------------------+------------------+------------------+------------------+
| **Rocket Chip    | Scala / Chisel   | Rocket           | TileLink, the    | You specifically |
| Generator**      |                  |                  | reference Rocket | want Rocket and  |
|                  |                  |                  | flow             | its surrounding  |
|                  |                  |                  |                  | generator stack  |
+------------------+------------------+------------------+------------------+------------------+
| **LiteX**        | Python / Migen / | VexRiscv         | W                | FPGA prototyping |
|                  | Amaranth         | (default), CVA6, | ishbone-centric, | with a huge      |
|                  |                  | NaxRiscv, others | very wide        | peripheral       |
|                  |                  |                  | peripheral       | palette and      |
|                  |                  |                  | library          | Python flow      |
+------------------+------------------+------------------+------------------+------------------+
| **OpenTitan**    | SystemVerilog    | Ibex             | Security-focused | Building a       |
|                  |                  | (se              | SoC, formally    | secure           |
|                  |                  | curity-hardened) | verified blocks  | root-of-trust    |
+------------------+------------------+------------------+------------------+------------------+
| **Cheshire /     | SystemVerilog    | CVA6             | Production PULP  | You want an      |
| Carfield         |                  |                  | CVA6 SoC,        | a                |
| (PULP)**         |                  |                  | single-core      | lready-validated |
|                  |                  |                  | focus            | CVA6 ASIC        |
|                  |                  |                  |                  | platform         |
+------------------+------------------+------------------+------------------+------------------+
| **CoreJack**     | SystemVerilog    | Eight swappable  | AXI4-centric,    | Comparing        |
|                  |                  | cores (and       | PULP fabric IP,  | several cores on |
|                  |                  | growing)         | d                | the same SoC,    |
|                  |                  |                  | escriptor-driven | with an          |
|                  |                  |                  | CORE/BOARD       | ASIC-aware       |
...
:doc:`support_matrix`. For the active direction
