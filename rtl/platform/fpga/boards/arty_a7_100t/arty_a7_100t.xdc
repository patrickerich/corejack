...
# JTAG signals are routed to Pmod JD; see docs/source/jtag_wiring.rst.
...
# External JTAG on Pmod JD (Arty uses Olimex ARM-USB-TINY; see docs/source/jtag_wiring.rst):
